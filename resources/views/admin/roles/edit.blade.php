            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex justify-between my-10">
                    ...
                    <div>
                        ...
                        <span class="py-2 px-2 bg-blue-300 rounded-md mr-2">{{ $permission->name }}</span>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="inline-block min-w-full py-2 align-middle">
                    <form method="POST" action="{{ route('admin.roles.permission', $role->id)}} ">
                        ...
                        <div class="form-group mb-6">
                            <label for="name" class="form-label inline-block mb-2 text-gray-700">Choose
                                Permission</label>
                            ...
                            <select multiple name="permissions[]"
                                ...
                                <option value="{{ $permission->id }}" @selected($role->
                                    hasPermission($permission->name))>{{ $permission->name }}</option>
                                @endforeach
                            </select>
                        </div>
